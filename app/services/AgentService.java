...
{
    public AgentResponse getAgentResponse(String text)//pass message as a parameter to agent
    {
        ...
        try
        {
            ...
            agent.keyword = response.get("result").get("parameters").get("keyword").asText();
